...
#
# Generated by Vivado on Tue Jan 14 19:52:44 -0500 2025
...
#    "S:/Vivado/controller_firmware/controller_firmware.srcs/utils_1/imports/synth_1/controller_firmware_top.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/controller_firmware/controller_firmware.srcs/utils_1/imports/synth_1/controller_firmware_top.dcp"]"\
  ]
  foreach ifile $files {
...
set file "synth_1/controller_firmware_top.dcp"
set file_obj [get_files -of_objects [get_filesets utils_1] [list "*$file"]]
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7z020clg400-1 -flow {Vivado Synthesis 2023} -strategy "Flow_PerfOptimized_high" -report_strategy {No Reports} -constrset constrs_1
} else {
...
set obj [get_runs synth_1]
set_property -name "part" -value "xc7z020clg400-1" -objects $obj
set_property -name "incremental_checkpoint" -value "$proj_dir/controller_firmware.srcs/utils_1/imports/synth_1/controller_firmware_top.dcp" -objects $obj
