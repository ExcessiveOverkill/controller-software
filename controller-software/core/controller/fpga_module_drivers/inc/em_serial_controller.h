...
class em_serial_controller : public base_driver {
    public:
        ...
        class em_serial_device{
            public:
                ...
                uint8_t get_pending_sequential_cmds(){return sequential_cmds.size();} // get the number of pending sequential cmds

                void set_cyclic_read_node_vars(uint8_t num_vars);
                void set_cyclic_write_node_vars(uint8_t num_vars);
                ...
                // these registers will be synced with the node program
                std::vector<Register*> cyclic_read_node_var_regs;
                std::vector<Register*> cyclic_write_node_var_regs;
            ...
            private:
                ...
                em_serial_controller* controller = nullptr;
                ...
                struct sequential_cmd{
                    ...
                    uint32_t data = 0;  // data to write from
                    void* data_pointer = nullptr; // pointer to the data to read into
                ...
                uint32_t* selected_cyclic_config = nullptr;
    ...
    private:
        ...
        //bool* enable = nullptr;
        //uint32_t* baud_rate = nullptr;
        uint32_t baud_rate_value = 0;
        uint32_t new_baud_rate = 115200;
